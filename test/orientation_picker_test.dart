...
void main() {
  ...
  const appPortraitOnly = MaterialApp(
    home: Scaffold(
      body: OrientationPicker.portraitOnly(portraitPlaceholder),
    ),
  );

  const appLandscapeOnly = MaterialApp(
    home: Scaffold(
      body: OrientationPicker.landscapeOnly(landscapePlaceholder),
    ),
  );
